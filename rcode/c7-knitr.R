### R code from vignette source 'c7-knitr.Rnw'
...
###################################################
### code chunk number 6: c7-knitr.Rnw:154-161 (eval = FALSE)
###################################################
## #Align time series
## IT = length(meas$London)
## Inow = log(meas$London[2:IT])
## Ilag = log(meas$London[1:(IT-1)])
## Slag = log(S[1:(IT-1)]) #This does not yet exist 
## #now the regression
